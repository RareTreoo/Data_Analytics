...
| [Сборный проект 2](P8_Сборный_проект_2.ipynb) | В данном проекте необходимо провести анализ результатов A/B теста для крупного интернет-магазина. Этапы: Приоритизация гипотез с помощью фреймворков ICE и RICE, проверка гипотез, оценка результатов A/B-тестирования| `pandas`, `numpy`, `matplotlib`, `scipy`, `math`|
